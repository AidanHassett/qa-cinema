...
const Classification = ({classification}) => {
  ...
  switch (classification) {
    case "U":
      return (
        <img src={ratingU} alt="Rated U" />
      );
      break;

      case "PG":
        return (
          <img src={ratingPG} alt="Rated PG" />
        );
        break;

      case "12A":
        return (
          <img src={rating12A} alt="Rated 12A" />
        );
        break;

      case "12":
        return (
          <img src={rating12} alt="Rated 12" />
        );
        break;

      case "15":
        return (
          <img src={rating15} alt="Rated 15" />
        );
        break;

      case "18":
        return (
          <img src={rating18} alt="Rated 18" />
        );
        break;

      case "R18":
        return (
          <img src={ratingR18} alt="Rated R18" />
        );
        break;
